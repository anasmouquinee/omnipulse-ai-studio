        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', maxWidth: '700px', margin: 0, lineHeight: 1.5 }}>
              Génère et publie automatiquement des Reels vidéo inédits sur <strong>Instagram (`@kae.islamic`)</strong> et <strong>TikTok (`@kaelar.islamic`)</strong> à intervalles réguliers en alternant harmonieusement entre le Coran, les Hadiths Sahih, les Invocations, Tahajjud et la Sagesse.
            </p>
          </div>
