...
export const ISLAMIC_BACKGROUND_THEMES: IslamicBackgroundTheme[] = [
  // 1. Viral TikTok Reciter Portrait Styles (Inspiration @c7l.11)
  {
    ...
    imageUrl: '/backgrounds/reciters/sheikh_luhaidan.jpg',
    overlayOpacity: 0.38,
    accentColor: '#38bdf8',
    textColor: '#f8fafc',
    arabicColor: '#ffffff',
  ...
  },
  {
    ...
    category: 'reciter_portrait',
    imageUrl: '/backgrounds/reciters/sheikh_alafasy.jpg',
    overlayOpacity: 0.38,
    accentColor: '#10b981',
    textColor: '#f8fafc',
    arabicColor: '#ffffff',
  ...
  },
  {
    ...
    category: 'reciter_portrait',
    imageUrl: '/backgrounds/reciters/sheikh_dossari.jpg',
    overlayOpacity: 0.38,
    accentColor: '#f59e0b',
    textColor: '#f8fafc',
    arabicColor: '#ffffff',
  ...
  },
  {
    ...
    category: 'reciter_portrait',
    imageUrl: '/backgrounds/reciters/sheikh_islamsobhi.jpg',
    overlayOpacity: 0.40,
    accentColor: '#fbbf24',
    textColor: '#f8fafc',
    arabicColor: '#ffffff',
